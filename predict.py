...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="RACNet_PAM", help="model name: Context Guided Network (CGNet)")
    ...
    parser.add_argument('--checkpoint', type=str,
                        default="./checkpoint/cityscapes/DABNet_PAM/bs8_gpu1_train_adam/model_208.pth",
