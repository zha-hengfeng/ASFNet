...
def predict(args, test_loader, model):
    ...
    for i, (input, size, name) in enumerate(test_loader):
        ...
        name[0] = name[0].rsplit('_', 1)[0]
        save_predict(output, None, name[0], args.dataset, args.save_seg_dir, output_grey=True, output_color=True, gt_color=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="apfnetv2r34c32", help="model name: [DABNet_PAM, EACNet_ERF]")
    ...
    parser.add_argument('--checkpoint', type=str,
                        default="checkpoint/cityscapes/apfnetv2/with_aux/model_568.pth",
