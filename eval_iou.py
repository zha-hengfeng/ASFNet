...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="apfnetv2r34c32", help="FCN-ResNet-18-C32, FCN-SKNet")
    parser.add_argument('--dataset', default="cityscapes", help="dataset: cityscapes or camvid")
    parser.add_argument('--num_workers', type=int, default=1, help="the number of parallel threads")
    parser.add_argument('--batch_size', type=int, default=1,
                        help=" the batch_size is set to 1 when evaluating or testing")
    parser.add_argument('--checkpoint', default="/home/zha/PycharmProjects/zha/APFNet/checkpoint/cityscapes/apfnetv2/with_aux/model_568.pth")
