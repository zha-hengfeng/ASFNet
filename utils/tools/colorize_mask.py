...
if __name__ == '__main__':
    ...
    save_path = 'D:/PyCharmProjects/EACNet-master/image/Seq05VD_f04920_C.png'
    gt = cv2.imread('D:/PyCharmProjects/EACNet-master/image/Seq05VD_f04920_P_P.png', cv2.IMREAD_GRAYSCALE)
    gt = np.asarray(gt, np.int64)
    gt_color = camvid_colorize_mask(gt)

    gt_color.save(save_path)
